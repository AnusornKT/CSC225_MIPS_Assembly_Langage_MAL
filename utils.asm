# File: utils.asm
# Purpose: To define utilities which will be used in MIPS programs. # Author: Charles Kann
#
# Instructors are granted permission to make copies of this file
# for use by # students in their courses. Title to and ownership # of all intellectual property rights
...
# subprogram:	Convert an integer to binary
# author:	Anusorn KT
# purpose:	to use this function to convert an interger as input to binary
# input:	an interger
# output:	binary
# side effects: The binary will be returned to the main
.text
getBinaryValue:
	add $a0, $s0, $zero
	li $v0, 35
...
# subprogram:	Convert an integer to hexadecimal
# author:	Anusorn KT
# purpose:	to use this function to convert an interger as input to hexadecimal
# input:	an interger
# output:	hexadecimal
# side effects: The binary will be returned to the main
.text
